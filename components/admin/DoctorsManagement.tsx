        ...
        <CardHeader className="flex items-center justify-between">
          <div>
            <CardTitle className="flex items-center gap-2">
              <Stethoscope className="size-5 text-primary" /> Doctors Management
            </CardTitle>
            <CardDescription>
              Manage and oversee all doctors within the system.
            </CardDescription>
          </div>
          <Button
            onClick={() => setIsAddDialogOpen(true)}
            className="bg-gradient-to-r from-primary to-primary/80
         hover:from-primary/90 hover:to-primary/100"
          >
            ...
            {doctors.map((doctor) => (
              ...
              border-border/50">
                <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="">
                        ...
                        <div className="text-sm text-muted-foreground">
                            {doctor.speciality}
                            <span className="ml-2 py-0.5 px-2 bg-muted rounded text-xs">
                ...
                <div className="flex items-center gap-3">
                    ...
                    {doctor.isActive ? (
                        <Badge className="bg-green-100 text-gray-800 hover:bg-green-200">Active</Badge>
                    ) : (
