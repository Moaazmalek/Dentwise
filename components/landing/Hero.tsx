...
const Hero = () => {
  return (
    <section className='relative min-h-screen flex items-center  overflow-hidden pt-20  md:pt-20 lg:pt-15  '>
      {/**GRID BG */}
      ...
      {/**Gradient ORBS */}
      <div className="absolute top-20 left-1/4 w-72 h-72 bg-linear-to-r from-primary/20 to-primary/10 rounded-full blur-3xl"></div>
      ...
      <div className='relative z-10 w-full px-6'>
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/**Left content */}
            <div className="space-y-10 flex flex-col items-center text-center md:text-left md:items-start justify-center">
              <div className="space-y-6">
                {/**BADGE */}
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-primary/10 to-primary/5 rounded-full
               ...
               <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                  ...
                  get personalized care recommendations. Avilable 24/7.
                </p>
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-1">
                        {[1,2,3,4,5].map((star) => (
                          <StarIcon  key={star} className='h-4 w-4 fill-primary text-primary'/>
                        ))}
                      </div>
            ...
            <div className="relative lg:pl-8">
              ...
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-br from-primary/15 to-primary/5 rounded-full blur-2xl"></div>
                ...
                width={600}
                height={600}
                className="w-64 sm:w-80 md:w-[80%] h-auto mx-auto lg:mx-0"
              />
              </div>
          </div>
        </div>
